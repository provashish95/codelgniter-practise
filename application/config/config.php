...
|
*/
$config['base_url'] = 'http://localhost:81/roy';
...
| See the employee guide for more info.
|
...
| 'sess_match_ip'
|
|	Whether to match the employee's IP address when reading the session data.
|
...
| helper' page of the employee guide for information regarding date handling.
|
*/
